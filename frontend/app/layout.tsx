...
export const metadata = {
  title: "Microsaas - Get a Second Brain with Generative AI",
  description:
    "Microsaas is your second brain in the cloud, designed to easily store and retrieve unstructured information.",
};
